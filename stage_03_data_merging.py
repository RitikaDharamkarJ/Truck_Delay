...
class DataMergingPipeline:
    ...
    def main(self):
        ...
        feature_store = datamerge_obj.get_feature_store(project_name, api_key)
        if feature_store:
        # Continue with the rest of your pipeline logic
         print("Proceeding with further steps in the pipeline.")
        # For example: Load data, create features, etc.
        else:
         print("Feature store connection failed. Exiting pipeline.")
        ...
        dfs = assign_feature_group_data_to_dfs(feature_group_data)        
        ...
        # Call the function
        drop_weather_columns_from_dfs(dfs, table_names, columns_to_drop)
